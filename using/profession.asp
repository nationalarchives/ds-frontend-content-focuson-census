...
%>
	<a href="profession_game.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('click','','images/navi_activity2.gif',1)" target="_self"><img name="click" border="0" src="images/navi_activity.gif" width="120" height="50" align="texttop" alt="click for game"></a>
<%
	Else
%>
	<a href="profession_game.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('click','','images/navi_activity2.gif',1)" target="_self"><img name="click" border="0" src="images/navi_activity.gif" width="120" height="50" align="texttop"></a>
<%
	End If
